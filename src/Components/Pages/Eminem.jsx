...
import useSpotifyStoreEminem from '../Store/spotifyConfigEminem'
import { Waveform } from 'ldrs/react'
import 'ldrs/react/Waveform.css'

const Eminem = () => {
  const { tracks, isLoading, error, EminemFetch } = useSpotifyStoreEminem()
  ...
  return (
    ...
    <div className='bg-zinc-200 my-4 mx-7 rounded-lg py-3 px-5'>
      <div className="flex flex-col my-3">
        <h2 className="text-2xl font-bold">Best Eminem Songs !</h2>
